...
public class Conta {
    //atributos privados: "ninguem pode acessar esses atributos fora da classe diretamente"
    private double saldo;  
    private int agencia;                            
    private int numero;
    private Cliente titular; //associao, ou, relacionamento de duas classes: Composicao (Conta -> Cliente)
